...
//     }
//   }, 1000)
//   const res = await loginApi.getCaptcha({ username: form.username })
//   if (res.code !== 0) {
//     canGetCaptcha.value = true;
...
//   const res = await loginApi.getAuthRouter()
//   if (res.code == 0) {
      ...
      <a-card>
        ...
        <div class="form-con">
          <a-form>
            ...
            <!-- 验证码 -->
            <a-form-item v-bind="validateInfos.captcha" style="display:flex;" v-if="showCaptcha">
              <a-input v-model:value="form.captcha" placeholder="验证码" />
              <a-button type="primary" :disabled="!canGetCaptcha" @click.prevent="getCaptcha">获取验证码
              </a-button>
            </a-form-item>

            <!-- 按钮 -->
            <a-form-item>
              <a-button type="primary" :loading="loading" block @click.prevent="onSubmit">登录</a-button>
            </a-form-item>
          </a-form>
        </div>
      </a-card>
